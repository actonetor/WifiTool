...
print("*                                          *") 
print("********************************************\n\n\n")  
ife = input("Avez vous installer les requirement ? ( oui ou non ) : ")
if not ife == ("oui") and ("non") and ("") :
    print("ERREUR: Entrer un nombre valide")
    quit()
if ife == str("non"):
    kel = input("Entrer le nom de votre system d'eploitation ( kali , parrot ou termux ) : ")
    if not kel == ("kali") and ("parrot") and ("termux") and ("") :
    ...
    if kel == str("parrot"):
        ...
        os.system("clear")
        print("[##########          ]  %50 ")
        os.system("cd /opt && wget https://raw.github.com/derv82/wifite/mastrer/wifite.py && mv wifite.py wifite && chmod 755 wifite && mv wifite /usr/bin")
        time.sleep(2)
        os.system("clear")
        print("[###############     ]  %75 ")
        ...
        os.system("clear")
        print("[####################]  %100 ")
        os.system("apt autoclean\u001b[0m")
        time.sleep(6)
        os.system("clear")
        sce = input("Voulez vous continuer ? ( oui ou non ) : ")
        if not sce == ("oui") and ("non") and (""):
            print("ERREUR: Entrer une options valide")
            quit()
        if sce == str("non"):
            quit()
    ...
    if kel == str("kali"):
        ...
        time.sleep(6)
        os.system("clear")
        sc = input("Vouler vous continuer ? ( oui ou non ) : ")
        if not sc == ("non") and ("oui") and (""):
            print("ERREUR: Entrer une options valide ")
            quit()
        if sc == str("non"):
            quit
    ...
    if kel == str("termux"):
        ...
        os.system("clear")
        print("[####################]  %100 ")
        os.system("apt install root-repo\u001b[0m")
        time.sleep(6)
        os.system("clear")
        sce = input("Voulez vous continuer ? ( oui ou non ) : ")        
        os.system("clear")
