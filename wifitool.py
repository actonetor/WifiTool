...
print("*                                          *") 
print("********************************************\n\n\n")
ter = input("Etrer le nom de votre system (termux , kali ou parrot ) : ")
if not ter == str("termux") and ("kali") and ("parrot") :
    print("ERREUR: Choisisser un system valide")
    quit()
if ter == str("termux"):
    print("INSTALLATION DES REQUIREMENTS TERMUX\n\n")
    print("CHARGEMENT\n")
    print("\u001b[32m[                    ]  %0 ")
    ...
    time.sleep(6)
if ter == str("kali") and ("parrot") :
    print("\u001b[31mINSTALLATION DES REQUIREMENT KALI ET PARROT OS\u001b[0m\n") 
    print("CHARGEMENT\n")
    print("\u001b[32m[                    ]  %0 ")
